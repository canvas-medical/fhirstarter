"""
Utility to automatically generate search function templates from the FHIR specification.

Search function templates are generated based on what search parameters are recognized for a given
resource type. These parameters need to appear in the function signatures in order to be recognized
by the documentation automatically generated by FastAPI.
"""
